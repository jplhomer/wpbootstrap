...
class bones_walker extends Walker_Nav_Menu {
	...
	function start_el(&$output, $item, $depth, $args) {
		...
		$attributes .= $is_parent					? ' data-toggle="dropdown"' : '';
		$attributes .= $is_parent					? ' class="dropdown-toggle"' : '';

		$item_output = $args->before;
		$item_output .= '<a'. $attributes .'>';
		$item_output .= $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after;
		//$item_output .= '<br /><span class="sub">' . $item->description . '</span>';
		$item_output .= $is_parent ? '<b class="caret"></b>' : '';
		$item_output .= '</a>';		
...
function page_navi($before = '', $after = '') {
	...
	echo $before.'<nav class="pagination pagination-right"><ol class="bones_page_navi clearfix">'."";
